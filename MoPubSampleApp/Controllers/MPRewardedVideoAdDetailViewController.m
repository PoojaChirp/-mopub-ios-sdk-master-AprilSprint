...
- (void)viewDidLoad
{
  ...
  // [[MoPub sharedInstance] initializeRewardedVideoWithGlobalMediationSettings:@[] delegate:self];
    ...
    //globalMediationSettings code added
    
    NSMutableArray *globalMediationSettings = [[NSMutableArray alloc] init];
    [globalMediationSettings addObject:@"ChartboostRewardedVideoCustomEvent"];
    
    [[MoPub sharedInstance]initializeRewardedVideoWithGlobalMediationSettings:globalMediationSettings delegate:self networkInitializationOrder:[MPRewardedVideoCustomEvent allCachedNetworks]];
    
     [globalMediationSettings addObject:@"IronSourceRewardedVideoCustomEvent"];
